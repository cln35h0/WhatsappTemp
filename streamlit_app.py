...
st.markdown(
    "Any file imported here is not my responsibility. I am only using this for my personal purpose. "
    "[Github↗](https://github.com/cln35h0/WhatsappTemp)."
)
...
st.markdown(
    """
This project is created and used only for **personal purpose only**.  

The author does **not claim ownership** or responsibility for any imported libraries, external files, or third-party resources used in this project.  

Use of this project is at your own risk. The author assumes **no liability** for any loss, damage, or misuse of the code, data, inputs, or outputs generated by this project.  
"""
)
